...
static const char *fonts[]  = { "Hack:size=12","Symbols Nerd Font:size=12" }; /* -f option overrides fonts[0] */
...
static uint32_t colors[][2] = {
	...
	[SchemeNorm] = { 0xf1be9bff, 0x020914ff },
	[SchemeSel]  = { 0xf1be9bff, 0x63576Eff },
	[SchemeOut]  = { 0x000000ff, 0x00ffffff },
};
